...
object SelectionManager {
    ...
    operator fun set(player: Player, value: PlayerSelection) {
    ...
    fun getColor(player: Player, selection: Selection) = listOf(
        Color.RED, Color.AQUA, Color.BLUE, Color.GRAY, Color.GREEN, Color.LIME, Color.FUCHSIA, Color.BLACK, Color.ORANGE,
        Color.SILVER, Color.MAROON, Color.NAVY, Color.TEAL
    ).random()
}