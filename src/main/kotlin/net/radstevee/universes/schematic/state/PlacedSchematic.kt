 ...
 */
class PlacedSchematic(val schematic: Schematic, val box: BlockBox) {
    /**
     * Gets a marker.
     * @param key The marker key.
     * @return The marker, or null.
     */
    fun getMarker(key: NamespacedKey) = schematic.markers[key]?.apply {
        pos = pos.add(box.min)
    }
     ...
     */
    fun getRegion(key: NamespacedKey) = schematic.regions[key]?.apply {
